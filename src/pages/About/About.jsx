    ...
    <>
      ...
      <div className="container lg:flex py-16">
        ...
        <div className="lg:ml-8">
          <h1 className="text-3xl font-Poppins font-semibold text-[#48525f]">
            Corporación Todo por un Alma
          </h1>
          <p className="py-8 text-[#48525f]">
          ...
          <div className="grid grid-cols-2">
            <ul>
              <li className="flex">
                ...
                <h1 className="text-lg pb-8 px-4 uppercase font-bold leading-snug text-[#48525f] hover:opacity-75">
