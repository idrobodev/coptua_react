...
ENV REACT_APP_AUTH_API_BASE_URL=https://todoporunalma.org/api/auth
ENV REACT_APP_DASHBOARD_API_BASE_URL=https://todoporunalma.org/api
ENV REACT_APP_API_BASE_URL=https://todoporunalma.org/api
ENV REACT_APP_FORMATOS_API_URL=https://todoporunalma.org/api/files
